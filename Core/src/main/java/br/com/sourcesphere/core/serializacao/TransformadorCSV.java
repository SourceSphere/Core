...
/**
 * Classe que implementa a transforma��o de um arquivo CSV para um objeto Java.<br>
 * O Arquivo n�o deve ser nulo e deve conter header com identifica��o igual aos atributos<br>
 * da classe ao qual ser� serializado.
 * <br>
 * <hr>
 * Exemplo:<br>
 * Arquivo CSV:<br>
